    ...
    >
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="#" class="mr-4 text-3xl"> Storage </a>
        ...
        >
          ...
          <li>
            ...
            >
              ...
              <span class="ml-3">Shared with me</span>
            </a>
          </li>
          <li>
            <a
            ...
            >
              ...
              <span class="ml-3">Shared by me</span>
            </a>
          </li>
          <li>
            <a
          ...
          <div class="max-w-screen-xl mx-auto w-full">
            ...
            >
              <div class="flex flex-row justify-between items-center p-4">
                ...
                <div
                  class="flex flex-row flex-wrap justify-end items-center gap-4 space-y-0"
                >
                  <button
                    type="button"
        ...
        >
          ...
          <tbody>
            ...
            >
              ...
              <td class="px-6 py-4">Me</td>
              <td class="px-6 py-4">1 minute ago</td>
              <td class="px-6 py-4">150.12 KB</td>
            </tr>
            <tr
              class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
            >
